...
$ npm i -D react-refresh @pmmmvh/react-refresh-webpack-plugin
...
리액트에선 require이 아닌 import from을 사용할 수 있다. babel이 require로 컴파일시키기 때문에 하위 버전 호환이 된다.
